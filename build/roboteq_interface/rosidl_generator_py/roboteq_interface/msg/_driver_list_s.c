...
bool roboteq_interface__msg__driver_list__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("roboteq_interface.msg._driver_list.DriverList", full_classname_dest, 45) == 0);
  }
  roboteq_interface__msg__DriverList * ros_message = _ros_message;
  {  // motors
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      int16_t * dest = ros_message->motors.data;
...
{
  /* NOTE(esteve): Call constructor of DriverList */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("roboteq_interface.msg._driver_list");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DriverList");
  ...
  {  // motors
    ...
    if (ros_message->motors.size > 0) {
      ...
      int16_t * src = &(ros_message->motors.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->motors.size * sizeof(int16_t));
      assert(data != NULL);
