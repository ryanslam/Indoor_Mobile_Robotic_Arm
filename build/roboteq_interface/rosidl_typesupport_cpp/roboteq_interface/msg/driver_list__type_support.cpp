...
static const _DriverList_type_support_symbol_names_t _DriverList_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, roboteq_interface, msg, DriverList)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, roboteq_interface, msg, DriverList)),
  }
};
...
{
  return &::roboteq_interface::msg::rosidl_typesupport_cpp::DriverList_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, roboteq_interface, msg, DriverList)() {
  return get_message_type_support_handle<roboteq_interface::msg::DriverList>();
}
